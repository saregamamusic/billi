...
from AaruXMusix.utils import AdminRightsCheck
from AaruXMusix.utils.database import is_active_chat, is_nonadmin_chat
from AaruXMusix.utils.decorators.language import languageCB
from AaruXMusix.utils.inline import close_markup, speed_markup
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    try:
        await AaruXMusix.speedup_stream(
            chat_id,
            file_path,
            speed,
            playing,
