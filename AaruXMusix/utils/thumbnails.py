...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("AaruXMusix/assets/font2.ttf", 30)
        font = ImageFont.truetype("AaruXMusix/assets/font.ttf", 30)
        title_font = ImageFont.truetype("AaruXMusix/assets/font3.ttf", 45)
